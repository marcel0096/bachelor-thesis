...
snowset.large.cust$createdTime <- ymd_hms(snowset.large.cust$createdTime, tz = "UTC", quiet = TRUE)
snowset.large.cust$minute_group <- floor_date(snowset.large.cust$createdTime, "minute")
snowset.large.cust.minute <- aggregate(totalCpuTime ~ minute_group, data = snowset.large.cust, FUN = sum)
