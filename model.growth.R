...
df.example.growth <- algorithm.with.growth(0.20, 100, list(16, 24, 0, 17, 18, 24, 3, 8, 24, 8, 15, 26, 17, 18, 50, 3, 8, 14, 10, 21, 15, 18, 6, 2))

df.example.grwoth2 <- algorithm.with.growth(0.20, 100, list(16, 24, 0, 17, 18, 24, 3, 8, 24, 8, 15, 26, 17, 18, 50, 3, 8, 14, 10, 21, 15, 18, 6, 2))

sum(df.example.growth[ , "Total_Costs"])
