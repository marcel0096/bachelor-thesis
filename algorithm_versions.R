...
# find.cheapest.instance.on.demand.wo.amdahl(10)
...
## extending the find.cheapest.instance.on.demand.with.amdahl function by also searching RI and SP
...
# ----------------------------------------------------------------------------------------------------------------------------------- #
# ----------------------------------------- ALGORITHM WITH BASE AND FLUCTUATING WORKLOADS ------------------------------------------- # 
# ----------------------------------------------------------------------------------------------------------------------------------- #

## giving the function the base workload as an int as well as the fluctuating workload as an array of 24 values representing 24 hours of a day
## Migration costs are not included
...
# ----------------------------------------------------------------------------------------------------------------------------------- #
# ------------------------------------------ ALGORITHM USING SPOT WITH MIGRATION COSTS ---------------------------------------------- # 
# ----------------------------------------------------------------------------------------------------------------------------------- #
